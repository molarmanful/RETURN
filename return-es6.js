...
commands={
	...
	"°":x=>(a=cur.pop(),b=cur,cur.splice(0,cur.length),cur.push(...b.map(x=>String.fromCodePoint(...x.pop?x:[x])).join(String.fromCodePoint(...a.pop?a:[a])).split``.map(x=>x.codePointAt()))),
