...
commands={
	...
	"\x03":x=>cur.reverse(),
	"\x04":x=>(a=cur.slice(0),cur.splice(0,cur.length),cur.concat(math.transpose(a))),
	"\x05":x=>(a=cur.slice(0),cur.splice(0,cur.length),cur.concat(math.flatten(a))),
	"\x06":x=>(a=cur.slice(0),cur.splice(0,cur.length),cur.concat(math.sort(a))),
