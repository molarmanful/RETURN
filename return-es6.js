...
commands={
	...
	"\x03":x=>cur.reverse(),
	"\x04":x=>(cur.splice(0,cur.length),cur.push(math.transpose(cur))),
	"\x05":x=>(cur.splice(0,cur.length),cur.push(math.flatten(cur))),
	"\x06":x=>(cur.splice(0,cur.length),cur.push(math.sort(cur))),
