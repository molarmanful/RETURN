...
commands = {
	...
	"\x04": function _(x) {
		return cur.splice(0, cur.length), cur.push(math.transpose(cur));
	},
	"\x05": function _(x) {
		return cur.splice(0, cur.length), cur.push(math.flatten(cur));
	},
	"\x06": function _(x) {
		return cur.splice(0, cur.length), cur.push(math.sort(cur));
	},
	"\x07": function _(x) {
